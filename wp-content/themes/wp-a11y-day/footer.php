...
<footer id="colophon" class="site-footer">
	<div class="site-info">
		<div class="event-info"><p>Follow us on Twitter: <a href="https://twitter.com/hashtag/WPAccessibilityDay">#WPAccessibilityDay</a> <a href="https://twitter.com/hashtag/WPAD2022">#WPAD2022</a> <a href="https://twitter.com/WPAccessibility">@WPAccessibility</a></p></div>
		...
		printf( esc_html__( 'Proudly powered by %s', 'wp-accessibility-day' ), '<a href="https://wordpress.org/">WordPress</a>' );
		?>
		<span class="sep"> | </span>
		<?php
			/* translators: 1: Theme name, 2: Theme author. */
			printf( esc_html__( 'Hosting: %s', 'wp-accessibility-day' ), '<a href="https://whodunit.fr">Whodunit</a>' );
		?>
	</div><!-- .site-info -->
</footer><!-- #colophon -->
</div><!-- #page -->
